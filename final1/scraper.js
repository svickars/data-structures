...
var content = fs.readFileSync('/home/ubuntu/workspace/final1/sourceHTML/' + zoneNumber + '.txt');
...
function convertTo24Hour(time) {
    ...
    // fs.writeFileSync('/home/ubuntu/workspace/final1/data/' + zoneNumber + '.json', JSON.stringify(meetingsData));
...
async.eachSeries(meetingsData, function(value, callback) {
    ...
    console.log(meetingsData);
    fs.writeFileSync('/home/ubuntu/workspace/final1/data/' + zoneNumber + '.txt', JSON.stringify(meetingsData));
});
